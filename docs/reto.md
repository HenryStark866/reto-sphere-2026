...
> Este es el **enunciado original del reto**, tal como venía en el README del repositorio
> base. Se conserva aquí sin cambios porque el README de la raíz ahora documenta la
> solución. Los enlaces se ajustaron a esta ubicación.
...
- **Cómo se evalúa tu entrega** → [`rubrica-evaluacion.md`](rubrica-evaluacion.md)
- **Stack abierto y modelos permitidos** → [`stack-tecnico.md`](stack-tecnico.md)
...
- **El stack es abierto; el modelo, no.** Orquestación, voz, RAG y embeddings los eliges
  ...
  [permitidos](stack-tecnico.md#1-los-modelos-permitidos) — y tienes que declarar en
...
Todos los datos del reto están en la carpeta [`../dataset/`](../dataset/) de este
repositorio. No hay que conectarse a nada externo para obtenerlos.
...
| **04** | **Video**: demo funcional con grabación de pantalla, más las [dos preguntas de cierre](rubrica-evaluacion.md#las-dos-preguntas-de-cierre-del-video) respondidas frente a cámara |
...
[`rubrica-evaluacion.md`](rubrica-evaluacion.md). Léelo antes de empezar a construir.
